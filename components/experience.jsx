...
const Experience = () => {
  return (
    <section
      ...
      "
    >
      <p className="px-8 py-8 text-2xl max-sm:text-xl font-semibold text-center dark:text-slate-300">
        Some Technologies I Work With
      </p>
      <div className="font-light tracking-wide w-11/12 m-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
        <div
          className="px-1 py-4 my-4 w-[300px] m-auto rounded-lg
        ...
        >
          <h4 className="pb-4 px-2 text-lg text-center font-bold dark:text-slate-400">Frontend</h4>
        ...
        <div
          className="px-1 py-4 my-4 w-[300px] m-auto rounded-lg
           ...
           dark:bg-gray-700/50 dark:bg-gradient-to-tr dark:from-gray-700/50 via-transparent"
        >
          <h4 className=" px-2 pb-4 text-lg text-center font-bold  dark:text-slate-400">Backend</h4>
          <div className="grid grid-cols-2 justify-between">
            <div className="flex ">
              <Image
                src="/django.svg"
        ...
        <div
          className="px-1 py-4 my-4  w-[300px] m-auto rounded-lg
           ...
           dark:bg-gray-700/50 dark:bg-gradient-to-tr dark:from-gray-700/50 via-transparent"
        >
          <h4 className="px-2 pb-4 text-lg text-center font-bold  dark:text-slate-400">Devops</h4>
          <div className="grid grid-cols-2 justify-between">
            <div className="flex ">
              <Image
                src="/linux.svg"
        ...
        <div
          className="px-1 py-4 my-4 w-[300px] m-auto rounded-lg
           ...
           dark:bg-gray-700/50 dark:bg-gradient-to-tr dark:from-gray-700/50 via-transparent"
        >
          <h4 className="px-2 pb-4 text-lg text-center font-bold  dark:text-slate-400">
            Languages
          </h4>
          <div className="grid grid-cols-2 justify-between">
            <div className="flex ">
            ...
            <div className="flex ">
              <Image
                ...
                alt="D"
              />
              <p className="px-2 py-4 text-md text-center">Dart</p>
            </div>
            <div className="flex ">
              <Image
                src="/typescript.svg"
