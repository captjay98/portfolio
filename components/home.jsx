  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center py-10 m-auto my-4 max-sm:mt-28 max-sm:mx-2 max-sm:w-full">
        <p className="font-light tracking-wide leading-normal text-black lg:text-3xl lg:leading-tight max-sm:text-[21px] text- md:text-[21px] dark:text-slate-400">
        ...
        <div className="flex justify-center pt-6 space-x-4 h-20">
          <Link href="https://www.github.com/captjay98">
            <Image
              src="/github.svg"
              className="w-10 h-auto rounded-full shadow-2xl shadow-blue-500 dark:bg-blue-500/70"
              width={35}
              height={35}
              alt="Github Logo"
            />
