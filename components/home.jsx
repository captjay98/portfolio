  ...
  return (
    ...
    >
      ...
      <div className="m-auto rounded-full max-sm:my-1 max-sm:w-[350px] lg:w-[350px]">
        ...
        <p class="text-slate-600 dark:text-slate-300 mb-[2px]"> Flutter</p>
        <p class="text-slate-600 dark:text-slate-300 mb-[2px]"> Laravel - Vue/Next - Postgres</p>
        <p class="text-slate-600  dark:text-slate-300"> Bun - Hono - React - Mongo/Postgres</p>
      </div>
      {/* <div className="m-auto rounded-full max-sm:my-1 max-sm:w-[350px] lg:w-[350px]"> */}
      {/*   <Image */}
      {/*     src="/jamal.webp" */}
