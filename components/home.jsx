...
const Home = () => {
  return (
    <section
      id="home"
      className="lg:h-screen w-[99%] animate-pulse repeat-1 my-4 m-auto bg-gray-100 dark:bg-gray-900 rounded-lg shadow-2xl mt-10 px-5 py-5 flex flex-wrap "
    >
      <div className="flex flex-col max-sm:h-96 justify-center m-auto my-8 py-14 ">
        <p className=" text-3xl max-sm:text-xl px-4 font-light tracking-wide leading-normal text-black dark:text-slate-200  text-center ">
